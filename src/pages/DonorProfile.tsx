...
// import { Donor, Organ, UserRole } from '../types';
...
//   // Type assertion since we know this page is only for donors
...
//     if (!currentUser) {
//       navigate('/login');
//     } else if (currentUser.role !== UserRole.DONOR) {
...
//                   {donor.organsToDonatе.map((organ) => (
//                     <OrganBadge 
//                       key={organ} 
//                       organ={organ} 
...
//         let donorData = {
//           organsToDonatе: [] as Organ[],
//           donationHistory: [],
//         };

//         if (donorDocSnap.exists()) {
//           donorData = donorDocSnap.data() as Pick<Donor, 'organsToDonatе' | 'donationHistory'>;
//         }
...
//           organsToDonatе: donorData.organsToDonatе,
